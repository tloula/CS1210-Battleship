...
#include "memory_functions_loula.h"                                      // NEW
...
int main() {
	...
	initMemoryloula(smartComputerMemory);                                // NEW
	...
	while (!done) {
		...
		//dumbComputerMove = getResponse(16, 0, "Please enter your move: ");
		...
		smartComputerMove = smartMoveloula(smartComputerMemory);       // CHANGED
		...
		smartComputerResult = playMove(smartComputerRow, smartComputerColumn,
			dumbComputerBoard);
		updateMemoryloula(smartComputerRow, smartComputerColumn,        // NEW
			smartComputerResult, smartComputerMemory);       // NEW
